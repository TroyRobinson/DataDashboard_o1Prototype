...
if __name__ == '__main__':
    ...
    port = int(os.environ.get('PORT', 5000))  # Use PORT provided by Render Host or default to 5000
    app.run(host='0.0.0.0', port=port, debug=True) # Configure host for Render
